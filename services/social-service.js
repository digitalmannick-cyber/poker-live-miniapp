...
function listFriendRecentShares(friendUserId) {
  return callSocialFunction('list_friend_recent_shares', { friendUserId: String(friendUserId || '').trim() })
}
