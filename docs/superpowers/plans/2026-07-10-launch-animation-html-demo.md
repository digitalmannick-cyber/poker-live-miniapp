...
**Architecture:** 使用单文件 `web-preview/launch-animation-demo.html` 承载 HTML、CSS 和少量原生 JavaScript，不引入框架或第三方动画库。复用项目内压缩主视觉，通过 CSS 变换、伪元素光效和状态类完成 1.6 秒启动序列。
...
- [ ] **Step 3: 实现手机比例舞台、主视觉、红光呼吸、轻微漂移、智牌屋文字、斜切退场和重新播放按钮。**
- [ ] **Step 4: 再次运行测试并确认通过。**
