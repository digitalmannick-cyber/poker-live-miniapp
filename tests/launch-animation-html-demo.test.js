...
assert.match(html, /AI-POWERED POKER INSIGHT/)
assert.doesNotMatch(html, /READ THE TABLE/)
...
assert.match(html, /--cut-duration:\s*520ms/)
assert.match(html, /calc\(var\(--launch-duration\) - var\(--cut-duration\)\)/)
assert.doesNotMatch(html, /loading-dots/)
